...
export const LEGAL = {
  line1:
    "Organizacja działa w ramach Next Real Spółka z ograniczoną odpowiedzialnością.",
  line2:
    "ul. Gdańska 13, 50-334 Wrocław · KRS 0001242343 · NIP 8982334148 · REGON 544812952",
  email: "info@nextrealstudio.com",
};
